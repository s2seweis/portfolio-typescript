...
import AnandBharti from "../../assets/profilepic.jpg";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            My name is Anand Bharti, I'm a Software Engineer with a great
        ...
        >
          <p>
            I develop websites and applications using React, HTML, CSS,
            JavaScript and Typescript. I am familiar with developing layouts
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.2 * 1000}>
          <img src={AnandBharti} alt="Anand Bharti" />
        </ScrollAnimation>
      </div>
    </Container>
  );
